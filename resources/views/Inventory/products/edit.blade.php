                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" min="0"
                                               ...
                                               value="{{ old('current_stock_sack', $product->current_stock_sack) }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0"
                                               ...
                                               value="{{ old('current_stock_kilo', $product->current_stock_kilo) }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" min="0"
                                               ...
                                               value="{{ old('current_stock_piece', $product->current_stock_piece) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" min="0"
                                               ...
                                               value="{{ old('critical_level_sack', $product->critical_level_sack) }}"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0"
                                               ...
                                               value="{{ old('critical_level_kilo', $product->critical_level_kilo) }}"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" min="0"
                                               ...
                                               value="{{ old('critical_level_piece', $product->critical_level_piece) }}"
                                               placeholder="Optional">
